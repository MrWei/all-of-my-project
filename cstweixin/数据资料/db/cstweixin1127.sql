...
-- ----------------------------
INSERT INTO `cst_member` VALUES ('1', 'admin', '0', '0000-00-00', '', '10', '10', '0', '1416964520', '2130706433', '1417055384', '1');
...
-- ----------------------------
-- Table structure for `cst_product_copy`
-- ----------------------------
DROP TABLE IF EXISTS `cst_product_copy`;
CREATE TABLE `cst_product_copy` (
  `uid` int(11) NOT NULL COMMENT '用户id',
  `pid` int(11) NOT NULL COMMENT '产品id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of cst_product_copy
-- ----------------------------
...
-- ----------------------------
INSERT INTO `cst_technology` VALUES ('1', '技术问题反馈', '1', '1', '0', '1416993285', '2');
INSERT INTO `cst_technology` VALUES ('2', '技术问题反馈2', '2', '2', '1', '1416993285', '3');
...
-- ----------------------------
INSERT INTO `cst_ucenter_member` VALUES ('1', 'admin', '4a0065997b56a6991afcb87929333043', 'weiyong.me@qq.com', '', '1416964520', '2130706433', '1417055384', '2130706433', '1416964520', '1');
...
-- ----------------------------
-- Table structure for `cst_userlabel`
-- ----------------------------
DROP TABLE IF EXISTS `cst_userlabel`;
CREATE TABLE `cst_userlabel` (
  `uid` int(11) NOT NULL COMMENT '用户id',
  `tid` int(11) NOT NULL COMMENT '产品id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of cst_userlabel
-- ----------------------------
