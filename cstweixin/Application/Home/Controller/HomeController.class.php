...
class HomeController extends Controller {
	 ...
	 * 返回数据集
	 */
	protected function infolists ($model,$where=array(),$order='',$base = array('status'=>array('egt',0)),$field=true,$limitrow=10){
		$options    =   array();
		...
		if( isset($REQUEST['r']) ){
			...
			$listRows = $limitrow > 0 ? $limitrow : 10;
		}
	 ...
	 * @return string        错误信息
	 */
	protected function showRegError($code){
		switch ($code) {
